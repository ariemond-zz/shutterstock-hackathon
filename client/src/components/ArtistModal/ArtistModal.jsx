...
import Wolf7 from "../../assets/images/wolf7.jpg";
import Wolf8 from "../../assets/images/wolf8.jpg";
import Wolf9 from "../../assets/images/wolf9.jpg";
    ...
    return (
      <div className="artist-modal">
        ...
        <img
          ...
          className="artist-modal__closeButton"
          src={closeButton}
          alt=""
        />
        <div className="artist-modal__images">
          ...
          <img src={Wolf7} alt="" className="artist-modal__image" />
          <img src={Wolf8} alt="" className="artist-modal__image" />
          <img src={Wolf9} alt="" className="artist-modal__image" />
        </div>
      </div>
    );
  }
